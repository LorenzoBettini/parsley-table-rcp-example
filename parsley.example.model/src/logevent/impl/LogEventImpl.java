 ...
 * @generated
 */
public class LogEventImpl extends MinimalEObjectImpl.Container implements LogEvent {
	/**
	...
	protected EClass eStaticClass() {
		return LogeventPackage.Literals.LOG_EVENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogeventPackage.LOG_EVENT__NAME, oldName, name));
	}
